# Fancy Wave Beauty Salon Website Brochure

Fancy Wave now has a polished customer website and a practical staff workspace in one system. Customers can discover the salon, compare services, book online, and manage their reservation. Staff can see the day at a glance, add appointments, adjust services and stylists, update hours, and keep the gallery fresh.
...
- Clear online booking call-to-action.
- Service menu with pricing and duration.
- Salon location and contact information.
- Image gallery for the shop atmosphere and finished styles.
- Mobile-friendly layout for customers booking from their phone.

## Online Reservation Flow

The booking flow guides customers step by step so the shop receives complete, usable appointment information.
...
- Guided booking from service to confirmation.
- Stylist-aware appointment availability.
- Automatic calendar blocking by service length.
- Customer notes for first-visit details and preferences.
- Confirmation page with appointment reference.
- Reschedule and cancellation controls for managed bookings.
- Email-ready booking confirmation flow.

## Staff And Admin Portal

The admin portal gives the salon a private workspace for daily scheduling and content management.
...
- Appointment list with status filters and customer search.
- Appointment detail drawer with customer history and notes.
